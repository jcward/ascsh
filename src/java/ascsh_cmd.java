...
public class ascsh_cmd
{
  ...
  {
    System.out.println("ascsh_cmd v0.5 by Jeff Ward, simbulus.com");
  ...
  public static void compile(String[] args)
  {
    ...
    if (command.equals("compile")) {
      ...
      if (idx>=compilers.size()) {
        System.out.println("ascsh: Target "+(idx+1)+" not found");
        return;
      } else {
      ...
      System.out.println("ascsh: Assigned "+(targets.size()+1)+" as the compile target id");
